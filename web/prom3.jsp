<%-- 
    Document   : prom3
    Created on : 27 Apr, 2022, 10:10:18 PM
    Author     : radhika
--%>
...
<div class="coupon">
  ...
  <img src="promo202.png" alt="Avatar" style="width:100%;">
  <div class="container" style="background-color:white">
    <h2><b>GET 20% OFF on minimum order of Rs.300 </b></h2> 
    <p></p>
  </div>
  <div class="container">
      <table style="border:1"  cellpadding="4">
      <tr><td align="left">Use Promo Code: <input type="text" name="t1" value="S2132" class="promo"></td></tr>
