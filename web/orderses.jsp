<%-- 
    Document   : orderses.jsp
    Created on : 27 May, 2020, 4:48:50 PM
    Author     : radhika
--%>
...
ses.setAttribute("z1", a1);
 ...
 ses.setAttribute("z2", a2);
   ...
   %>
    ...
    <tr style="text-align:left"><td style="border:0">Order Type</td>
    <td style="border:0"><input type="radio" name="r2" value="Pick up">Pick Up<input type="radio" name="r2" value="Delivery">Delivery</td>
   </tr>
