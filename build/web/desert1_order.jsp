<%-- 
    Document   : desert1_order
    Created on : 29 May, 2020, 12:40:52 AM
    Author     : radhika
--%>
 ...
 ses.setAttribute("z2", a2);
   ...
   %>
    ...
    <tr style="text-align:left"><td style="border:0">Item</td>
        <td style="text-align:left"><input type="text" name="t1"  value="<%=a1%>"  placeholder="item"   readonly="readonly" ></td></tr>
