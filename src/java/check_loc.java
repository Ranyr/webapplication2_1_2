 ...
 * @author radhika
 */
public class check_loc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
             ...
             if(n1.equals("amritsar")){
            
                 response.sendRedirect("restaurant.jsp");
             }
             else{
             out.println("<h1>Service is available only in amritsar<h1>");
             out.println("<a href='homepage.jsp'>choose location again</a>");
             }
